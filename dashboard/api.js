const api = {
  ...
  createPrompt: (name, content) => api.post('/api/prompts', { name, content }),
  updatePrompt: (name, content) => api.put(`/api/prompts/${encodeURIComponent(name)}`, { content }),
  deletePrompt: (name) => api.del(`/api/prompts/${encodeURIComponent(name)}`),
  ...
  createStandard: (name, content) => api.post('/api/standards', { name, content }),
  updateStandard: (name, content) => api.put(`/api/standards/${encodeURIComponent(name)}`, { content }),
  deleteStandard: (name) => api.del(`/api/standards/${encodeURIComponent(name)}`),
  aiGenerateStandard: (idea) => api.post('/api/standards/ai-generate', { idea }),
  ...
  getCustomTemplates: () => api.get('/api/tasks/templates/custom'),
  addCustomTemplate: (data) => api.post('/api/tasks/templates/custom', data),
  deleteCustomTemplate: (id) => api.del(`/api/tasks/templates/custom/${encodeURIComponent(id)}`),
